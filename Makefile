...
help:
	...
	@echo  '  build_csitool   - Build CSITOOL-enabled kernel and uBoot image'
	@echo  '  install_csitool - Install CSITOOL-enabled kernel and uBoot image'
...
clean: $(clean-dirs)
	...
	$(Q)rm -f ./uImage
	$(Q)rm -f ./arch/arm/boot/zImage-dtb
	$(Q)rm -rf ./output
